...
def oneD_flow_modeling(diameter, PD, guess, c):
    test = FlowIteration(diameter, PD, c, guess)
    test.Iterate()
...
if __name__ == '__main__':
    ...
    parser.add_argument("guess", type=float, help="guess N channels.")
    ...
    oneD_flow_modeling(args.diameter, args.PD, args.guess, args.clad_t)
