...
mu = 0.00004308 # coolant viscosity [kg/m-s]
Cp_cool = 1274 # coolant specific heat [J/kg-k]
rho_cool = 88.24 # coolant density [kg/m^3]
rho_W = 19250 # clad density [kg/m^3]
rho_UN = 11300 # fuel density [kg/m^3]

Q_therm = 131073 # core thermal power [W]
...
T_centerline = 1123 # centerline fuel temperature [K]
